  ...
  return (
    ...
    >
      <div className="container contacts__grid">
        ...
        <form className="contact-form glass-panel" onSubmit={form.handleSubmit} noValidate>
          <label>
          ...
          {form.serverMessage ? (
            <p className={`contact-form__status contact-form__status--${form.status}`}>{form.serverMessage}</p>
          ) : null}
          ...
          <div className="contact-form__actions">
            ...
            <button className="button button--ghost" type="button" onClick={form.resetForm}>
              {t('contacts.reset')}
            </button>
          </div>
        </form>
